    ...
    return (
        <div className='container mx-auto my-5 border rounded flex flex-col sm:flex-row'>
            ...
            <div className='m-5 flex flex-col gap-6 h-80 w-1/2'>
                <h2 className='bg-gray-200 h-14 overflow-y-scroll overflow-x-hidden text-xl font-bold text-justify p-1'>{titulo}</h2>
                <p className='bg-gray-200 h-full overflow-y-scroll overflow-x-hidden text-justify p-1'>{descripcion}</p>
